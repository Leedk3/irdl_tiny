#ifndef ZEROMQ_BRIDGE_SUB_H
#define ZEROMQ_BRIDGE_SUB_H
...
class ZeroMQBridgeSub : public rclcpp::Node{
public:
    ZeroMQBridgeSub(const std::string &node_name);
    ~ZeroMQBridgeSub();
